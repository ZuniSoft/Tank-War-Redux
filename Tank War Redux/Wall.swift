...
class Wall{
    ...
    init(){
        ...
        ws.append(Rectangle(x: 520,y: 262,w: 32,h: 64))
        ...
        ws.append(Rectangle(x: 284,y: 0,w: 32,h: 64))
    ...
    func draw(_ view:UIView){
        ...
        w.frame = CGRect(x: 520, y: 262, width: 32, height: 64)
        view.addSubview(w)
        w = UIImageView(image: Wall.w2)
        ...
        view.addSubview(w)
        w = UIImageView(image: Wall.w3)
        w.frame = CGRect(x: 282, y: 0, width: 32, height: 64)
        view.addSubview(w)
        w = UIImageView(image: Wall.w2)
